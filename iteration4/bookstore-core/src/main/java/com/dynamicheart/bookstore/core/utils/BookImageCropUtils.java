...
public class BookImageCropUtils {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(BookImageCropUtils.class);
	...
	public BookImageCropUtils(BufferedImage file, int largeImageWidth, int largeImageHeight) {
